...
class BeastFeedbacks_Admin {
	...
	public function add_type_filter() {
		...
		$nonce_verified = isset( $_GET['_beastfeedbacks_nonce'] ) && wp_verify_nonce( wp_unslash( $_GET['_beastfeedbacks_nonce'] ), 'beastfeedbacks_filter' );
	...
	public function type_filter_result( $query ) {
		$nonce_verified = ( isset( $_REQUEST['_beastfeedbacks_nonce'] ) && wp_verify_nonce( wp_unslash( $_REQUEST['_beastfeedbacks_nonce'] ), 'beastfeedbacks_filter' ) )
			|| ( isset( $_REQUEST['_wpnonce'] ) && wp_verify_nonce( wp_unslash( $_REQUEST['_wpnonce'] ), 'beastfeedbacks_csv_export' ) );
